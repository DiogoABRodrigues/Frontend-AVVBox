...
export const styles = StyleSheet.create({
  ...
  historyItem: { backgroundColor: '#fff', borderRadius: 12, padding: 12, marginBottom: 8 },
  historyDate: { fontSize: 16, fontWeight: 'bold' },
  historyDetails: { marginTop: 8, paddingLeft: 8 },
});
