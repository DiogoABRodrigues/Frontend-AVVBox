  ...
  export default function ChangeRoleModal({ visible, onClose, onConfirm, currentRole }: Props) {
    const [selectedRole, setSelectedRole] = useState<"atleta" | "PT" | "Admin">(currentRole);
