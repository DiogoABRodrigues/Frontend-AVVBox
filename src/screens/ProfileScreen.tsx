...
import { Availability } from "../models/Availability";
  ...
  export default function ProfileScreen() {
    ...
    const actions = [
      ...
      ...((isAdmin || isPT) ? [{ title: "Alterar Disponibilidade", icon: "calendar-outline" }] : []),
          ...
          {actions.map((action, index) => (
            <View key={index} style={styles.actionContainer}>
              ...
              {/* Alterar Disponibilidade */}
                {expandedAction === "Alterar Disponibilidade" && action.title === "Alterar Disponibilidade" && (
                  <View style={styles.expandedContainer}>
                    <View style={styles.formContainer}>
                      <ScrollView showsVerticalScrollIndicator={false}>
                        {/* Máximo de atletas por hora */}
                        <View style={styles.inputGroup}>
                          <Text style={styles.label}>Máximo de atletas por hora</Text>
                          <TextInput
                        ...
                        {(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'] as const).map((day) => (
                          <View key={day} style={[
                            styles.dayContainer,
                            !availability[day].working && styles.dayContainerDisabled
                          ]}>
                            <View style={styles.dayHeader}>
                              <Text style={[
                                styles.dayTitle,
                                !availability[day].working && styles.dayTitleDisabled
                              ]}>
                                {day === 'Monday' ? 'Segunda' :
                                day === 'Tuesday' ? 'Terça' :
                              ...
                              <TouchableOpacity
                                style={[
                                  ...
                                  availability[day].working && styles.workingDayToggleActive
                                ]}
                                onPress={() => toggleWorkingDay(day)}
                              >
                                <Text style={[
                                  styles.workingDayText,
                                  availability[day].working && styles.workingDayTextActive
                                ]}>
                                  {availability[day].working ? 'Trabalho' : 'Não trabalho'}
                                </Text>
                              </TouchableOpacity>
                            </View>
                            ...
                            <View style={[
                              ...
                              !availability[day].working && styles.timeRangesContainerDisabled
                            ]}>
                              {availability[day].intervals.map((range, index) => (
                                <View key={index} style={[
                                  styles.timeRangeRow,
                                  !availability[day].working && styles.timeRangeRowDisabled
                                ]}>
                                  <TextInput
                                    style={[
                                      styles.timeInput,
                                      !availability[day].working && styles.timeInputDisabled
                                    ]}
                                    value={range.start}
                                  ...
                                  <Text style={[
                                    ...
                                    !availability[day].working && styles.timeSeparatorDisabled
                                  ]}>às</Text>
                                  <TextInput
                                    style={[
                                      styles.timeInput,
                                  ...
                                  <TouchableOpacity
                                    style={[
                                      ...
                                      !availability[day].working && styles.removeTimeButtonDisabled
                                    ]}
                                  ...
                                  >
                                    <Ionicons 
                                      name="trash-outline" 
                                      size={16} 
                                      color={!availability[day].working ? "#9ca3af" : "#dc2626"} 
                                    />
                                  </TouchableOpacity>
                                </View>
                              ))}
                              ...
                              <TouchableOpacity
                                style={[
                                  ...
                                  !availability[day].working && styles.addTimeButtonDisabled
                                ]}
                              ...
                              >
                                <Ionicons 
                                  name="add" 
                                  size={16} 
                                  color={!availability[day].working ? "#9ca3af" : "#2563eb"} 
                                />
                                <Text style={[
                                  styles.addTimeButtonText,
                                  !availability[day].working && styles.addTimeButtonTextDisabled
                                ]}>Adicionar horário</Text>
                              </TouchableOpacity>
                            </View>
                          </View>
                        ))}
